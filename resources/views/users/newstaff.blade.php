...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Tạo tài khoản nhân viên') }}</div>
                ...
                <div class="card-body">
                    {!! Form::open([ 'action' => ['UsersController@createStaff'], 'method' => 'POST', ]) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="staff_name" type="text" value="{{ $staff_name }}" class="form-control @error('staff_name') is-invalid @enderror" name="staff_name" required>
